...
INSERT INTO public.status (status_name, status_description) VALUES
-- Машина
(N'Доступна', N'Машина готова к аренде'),
(N'Недоступна', N'Машина временно недоступна'),
(N'На обслуживании', N'Проводится техническое обслуживание'),
(N'В ремонте', N'Машина недоступна из-за ремонта'),

-- Бронирование
(N'Активно', N'Бронирование действует'),
(N'Завершено', N'Бронирование завершено'),
(N'Отменено', N'Бронирование отменено'),

-- Поездка
(N'Ожидание начала', N'Поездка ещё не началась'),
(N'В пути', N'Поездка активна'),
(N'Завершена', N'Поездка окончена'),
(N'Отменена системой', N'Поездка отменена автоматически'),
(N'Требуется оплата', N'Есть неоплаченные начисления'),
...
-- Штрафы
(N'Начислен', N'Штраф назначен'),
(N'Ожидает оплаты', N'Необходимо оплатить штраф'),
(N'Оплачен', N'Штраф оплачен'),

-- Промокод
(N'Активен', N'Промокод доступен к использованию'),
(N'Истёк', N'Срок действия промокода закончился'),
(N'Использован', N'Промокод уже был применён'),

-- Страховка автомобиля
(N'Активна', N'Страховой полис действует'),
(N'Истекла', N'Срок действия страхового полиса завершён'),
(N'Аннулирована', N'Страховой полис был аннулирован');

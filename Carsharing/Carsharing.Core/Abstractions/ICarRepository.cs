...
namespace Carsharing.Core.Abstractions
{
    public interface ICarRepository
    {
        ...
        Task<int> Update(int id, int? statusId, int? tariffId, int? categoryId, int? specificationId, string? location, double? latitude, double? longitude, decimal? fuelLevel, string? imagePath, CancellationToken cancellationToken);

import {
  ...
  DELETE_TRIP_SUCCESS,
  DELETE_TRIP_FAILED,
  GET_MY_TRIPS_STARTED,
  GET_MY_TRIPS_SUCCESS,
  GET_MY_TRIPS_FAILED,
  GET_INFO_TRIP_STARTED,
  GET_INFO_TRIP_SUCCESS,
  GET_INFO_TRIP_FAILED,
  SET_TRIPS_TOTAL,
  SET_MY_TRIPS_TOTAL,
  GET_ACTIVE_TRIP_STARTED,
  GET_ACTIVE_TRIP_SUCCESS,
  GET_ACTIVE_TRIP_FAILED,
  FINISH_TRIP_STARTED,
  FINISH_TRIP_SUCCESS,
  FINISH_TRIP_FAILED,

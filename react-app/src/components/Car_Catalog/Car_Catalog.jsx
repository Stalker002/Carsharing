...
import car4 from "../../svg/Popular_Car/prevyu_Tesla_X.jpg";
          ...
          {popular_cars.map((car) => (
            ...
            <div key={car.id} className="card-card">
              ...
              <div className="card-info">
                {car.fuel && (
                  <div className="card-icon"><img src={Fuel} /> {car.fuel} </div>
                )}
                <div className="card-icon"><img src={Transmission} />{car.transmission}</div>
                <div className="card-icon"><img src={People} />{car.capacity}</div>
              </div>
